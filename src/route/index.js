  ...
  res.render('education', {
    ...
    main: {
      ...
      certificates: [
        ...
        {
          name: 'Сертифікат із курсів',
          id: 8888,
        },
        {
          name: 'Позитивна рекомендація',
          id: 9999,
        },
      ],
    },
      ...
      works: [
        {
          ...
          projects: [
            {
              name: 'Resume',
              url: 'http://www.resume.com.ua',
              about: 'easy resume for users',
              stack: [
                {
                  name: 'HTML / CSS',
                },
